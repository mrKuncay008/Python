...
def totalbeli():
	global ap, s, k, db, t_total, t_uang, total, subtotal, t_sub
	ha = ap.get() * 189000
	hs = s.get() * 165000
	hk = k.get() * 123000
	hd = db.get() * 119000
...
Label(app, text='PPN (11 %) ').place(x=450, y=320)
Label(app, text='Subtotal:', font='arial 9').place(x=450,y=340)
Label(app, text='Rp', textvariable=t_sub, fg='black', font='arial 9').place(x=450,y=360)
